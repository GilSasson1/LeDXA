...
import wandb
from model.datasets import HybridDEXADataset
...
# --- 6. Main ---
def main():
    wandb.init(entity="your-wandb-entity", project="LeJEPA_DEXA_Scratch", name="LeJEPA_RealCrops_ValCheck", resume="allow")
